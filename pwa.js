...
const cacheName = 'Group6BFinal-2020-11-21 14:13:43.044786'; // unique value, generated each deploy
const contentToCache = [
  'index.html',
  'code.js',
  'images/bluejay.png',
  'toolbox/jqm/dist/jquery.mobile.css',
  'toolbox/jqm/dist/jquery.mobile.js',
  'toolbox/jqm/dist/jqmFunctions.js',
  'toolbox/jqm/dist/images/ajax-loader.gif',
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Group6BFinal'.length) === 'Group6BFinal') {
